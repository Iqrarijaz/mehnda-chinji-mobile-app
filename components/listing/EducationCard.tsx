...
const EducationCard = React.memo(({ data }: EducationCardProps) => {
                            ...
                            {description ? (
                                <View style={styles.sectionContainer}>
                                    ...
                                    <View style={styles.infoRow}>
                                        <Ionicons name="information-circle-outline" size={20} color={colors.border} />
                                        <ThemedText style={[styles.infoText, { color: colors.text }]}>{description}</ThemedText>
                                    </View>
