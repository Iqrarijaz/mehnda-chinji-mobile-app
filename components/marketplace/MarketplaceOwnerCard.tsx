...
export const MarketplaceCard = memo(({ item, colors, onEdit, showActions }: MarketplaceCardProps) => {
    ...
    const handleChat = () => {
        ...
        router.push({
            ...
            params: { receiverId: sellerId, listingId: item._id, listingTitle: item.title }
        });
    };
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.card }]}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <ThemedText style={[styles.title, { color: colors.primary }]} numberOfLines={1}>
                    {item.title}
                </ThemedText>
                ...
                {!isOwner && item.status === 'live' && (
                    <View style={styles.actionRow}>
                        <TouchableOpacity style={[styles.actionButton, styles.chatButton, { borderColor: colors.primary }]} onPress={handleChat}>
                            <Ionicons name="chatbubble-ellipses-outline" size={18} color={colors.primary} />
                            <ThemedText style={[styles.actionButtonText, { color: colors.primary }]}>Chat</ThemedText>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.actionButton, styles.callButton, { backgroundColor: colors.primary }]} onPress={handleCall}>
                            <Ionicons name="call-outline" size={18} color="#fff" />
                            <ThemedText style={[styles.actionButtonText, { color: '#fff' }]}>Call Seller</ThemedText>
                        </TouchableOpacity>
                    </View>
                )}
            </View>
