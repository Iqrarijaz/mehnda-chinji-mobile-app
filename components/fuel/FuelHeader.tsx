...
/**
 * Custom hero header for the Fuel Prices screen — mirrors CurrencyHeader/
 * MetalsHeader's primary-colored rounded-bottom band so all three "rates"
                ...
                <View style={styles.titleWrap}>
                    <View style={styles.titleRow}>
                        ...
                        <View style={[styles.badge, { backgroundColor: colors.lime }]}>
                            <ThemedText style={styles.badgeText}>PSO</ThemedText>
                        </View>
                    </View>
                    <ThemedText style={styles.subtitle} numberOfLines={1}>
                        {lastUpdatedLabel ? `Updated ${lastUpdatedLabel} · official pump prices` : 'Fetching latest prices…'}
                    </ThemedText>
                </View>
            </View>
        </View>
